...
<body>
                ...
                <div class="carousel-item active">
                    ...
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 900px;">
                            ...
                            <h5 class="text-white mb-3 d-none d-sm-block">Always have your pets' best interests at heart.</h5>
                            <a href="" class="btn btn-lg btn-primary mt-3 mt-md-4 px-4">Register Now</a>
                ...
                <div class="carousel-item">
                    ...
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 900px;">
                            ...
                            <h5 class="text-white mb-3 d-none d-sm-block">A caring way every day.</h5>
                            <a href="register.jsp" class="btn btn-lg btn-primary mt-3 mt-md-4 px-4">Register Now</a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div id="about" class="container py-5">
        <div class="row py-5">
            <div class="col-lg-7 pb-5 pb-lg-0 px-3 px-lg-5">
                ...
                <h5 class="text-muted mb-3">PetClinic is passionate about providing compassionate wellness care to ensure that your pet is always feeling their best. Our expert team is experienced in wellness care for animals of all breeds and ages.</h5>
                <p class="mb-4"></p>
    ...
    <!-- Services Start -->
    <div id="services" class="container-fluid bg-light pt-5">
    ...
    <div class="container">
        <div class="row align-items-center">
            ...
            <div class="col-lg-7 py-5 py-lg-0 px-3 px-lg-5">
                ...
                <p class="mb-4">We understand that veterinary care is not one-size-fits-all, so we make it our mission to design individualized treatment plans that are specific to your pet's needs.</p>
                <div class="row py-2">
                    <div class="col-6">
        ...
        <div class="row">
            <div class="col-md-6 text-center text-md-left mb-3 mb-md-0">
                <p class="m-0 text-white">
                    &copy; <a class="text-white font-weight-bold" href="#">PetClinic</a>. All Rights Reserved. Designed by
